...
public class Q03{
    ...
    public static List fillList(int n){
        boolean stop = false;        
        String str = new String();

        Game[] gamesArray = readCsv();
        List games = new List(n);
    ...
    public static void matriculaSequencial(double d, int n){
        try{
            Formatter file = new Formatter("matricula_sequencial.txt");

            file.format("774119\t%f\t%d", d, n);
    ...
    public static void main(String[] args){
        ...
        matriculaSequencial(end - start, games.getComparisons());
    }
}
