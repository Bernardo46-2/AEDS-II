...
class Game{
    ...
    public int compareTo(Game other){            
        ...
        if(!this.upvotes.equals(other.getUpvotes())) diff = this.upvotes.compareTo(other.getUpvotes()) < 0 ? -1 : 1;
...
public class Q09{
    ...
    public static void matriculaMergesort(int c, int m, long t){
        try{
            Formatter f = new Formatter("matricula_mergesort.txt");
    ...
    public static void main(String[] args){
        ...
        matriculaMergesort(list.getComp(), list.getMov(), end - start);
    }
}
