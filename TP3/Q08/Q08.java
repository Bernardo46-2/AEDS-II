...
class Game{
    ...
    public int compareTo(Game game){
        int diff = this.developers.compareTo(game.getDevelopers());
...
public class Q08{
    ...
    public static void matriculaBolha(int c, int m, long t){
        try{
            Formatter f = new Formatter("matricula_bolha.txt");
    ...
    public static void main(String[] args){
        ...
        matriculaBolha(list.getComp(), list.getMov(), end - start);
    }
}
