...
public class Q01{
    ...
    public static void matriculaSelecao(int c, int m, long t){
        try{
            Formatter f = new Formatter("matricula_selecao.txt");
    ...
    public static void main(String[] args){
        ...
        matriculaSelecao(list.getComp(), list.getMov(), list.getTime());
    }
}
